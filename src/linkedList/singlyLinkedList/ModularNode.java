...
public class ModularNode {
	...
	public static void main(String[] args) {
		...
		Node m1 = findLastModularNodeFromFront(head, 19, 3);
		System.out.println(" Modular Node from Begining : " + (m1 != null ? m1.getData() : m1));
		Node m2 = findModularNodeFromEnd(head, 19, 3);
	 ...
	 */
	private static Node findLastModularNodeFromFront(Node head, int listSize, int mod) {
	 ...
	 */
	private static Node findModularNodeFromEnd(Node head, int listSize, int mod) {
